...
class GaranteNotifier extends ChangeNotifier {
  ...
  //todo mapa y obtencion de valor de mapa garate
  ...
  String? getValuegarante(String key) => _datos[key].toString();

  //todo mapa y obtencion de valor de mapa NACIMIENTO - garante
  ...
  //todo mapa y obtencion de valor de mapa IDENTIFICACION - garante
  ...
  //todo mapa y obtencion de valor de mapa RESIDENCIA - garante
  ...
  //todo mapa y obtencion de valor de mapa EDUCACION - garante
  ...
  //todo mapa y obtencion de valor de mapa ACT ECON PRIN -  garante
  ...
  //todo mapa y obtencion de valor de mapa ACT ECON SECU - garante
  ...
  //todo mapa y obtencion de valor de mapa SIT ECONOMICA - garante
  ...
  //todo mapa y obtencion de valor de mapa ESTADO CIVIL - garante
  ...
  //todo actualizar dato del garante
  void updateValuegarante(String key, String? value) {
    _datos[key] = value;
    notifyListeners();
  }
