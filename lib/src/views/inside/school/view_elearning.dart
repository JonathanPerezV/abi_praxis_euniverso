...
import 'package:abi_praxis_app/src/views/inside/school/aproved.dart';
import 'package:abi_praxis_app/utils/buttons.dart';
import 'package:abi_praxis_app/utils/header.dart';
import 'package:abi_praxis_app/utils/list/questions.dart';
...
class _ElearningState extends State<Elearning> {
  ...
  void initState() {
    ...
    for (var i = 0; i < listChecks.length; i++) {
      debugPrint("lista de checks: ${listChecks[0][i]["result"]}");
    }
