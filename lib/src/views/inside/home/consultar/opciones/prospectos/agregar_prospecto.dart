  ...
  void getData() async {
    ...
    if (res != null) {
      ...
      setState(() {
        ...
        if (res.pais != null && res.pais == "ECUADOR") {
          pais = res.pais!;
          funcionPais(pais);
        ...
        } else if (res.pais == "OTRO") {
          pais = "OTRO";
          txtPais.text = res.pais!;
          txtProvincia.text = res.provincia!;
  ...
  void validateButton() async {
    ...
    if (_formkey.currentState!.validate()) {
      ...
      final persona = PersonaModel(
          ...
          pais: pais ?? txtPais.text.toUpperCase(),
          provincia: provincia ?? txtProvincia.text.toUpperCase(),
          ciudad: ciudad ?? txtCiudad.text.toUpperCase(),
          idRDS: idRDS);
