...
import 'package:abi_praxis_app/src/views/inside/home/vendedor/consultar/opciones/prospectos/clientes/contactos_cliente.dart';
import 'package:abi_praxis_app/src/views/inside/home/vendedor/consultar/opciones/prospectos/solicitudes.dart';
    ...
    return Column(children: [
              ...
              Expanded(
                child: Text(
                  widget.prospecto.provincia != null
                      ? listaProvinciasEcuador["provincias"]
                          .where((e) => e["id"] == widget.prospecto.provincia!)
                          .first["nombre"]
              ...
              Expanded(
                child: Text(
                  widget.prospecto.ciudad != null
                      ? obtenerCiudadesEcuadorDe(widget.prospecto.provincia!)
                          .where((e) => e["id_c"] == widget.prospecto.ciudad!)
                          .first["nombre"]
      ...
      HeaderContainer(
        ...
        body: Row(
          children: [
            ...
            (widget.prospecto.longitud != null &&
                        widget.prospecto.longitud!.isNotEmpty) &&
                    (widget.prospecto.latitud != null &&
                        widget.prospecto.latitud!.isNotEmpty)
                ? IconButton(
                    onPressed: () async {
                      final coor = await Geolocator.getCurrentPosition();

                      String url =
                          'https://www.google.com/maps/search/?api=1&query=${widget.prospecto.latitud},${widget.prospecto.longitud}';
      ...
      HeaderContainer(
        ...
        body: Row(children: [
          ...
          (widget.prospecto.latitudTrabajo != null &&
                      widget.prospecto.latitudTrabajo!.isNotEmpty) &&
                  (widget.prospecto.longitudTrabajo != null &&
                      widget.prospecto.longitudTrabajo!.isNotEmpty)
              ? IconButton(
                  onPressed: () async {
                    String url =
                        'https://www.google.com/maps/search/?api=1&query=${widget.prospecto.latitudTrabajo},${widget.prospecto.longitudTrabajo}';
