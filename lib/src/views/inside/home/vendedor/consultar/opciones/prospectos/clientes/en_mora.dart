...
class EnMora extends StatefulWidget {
  final ValueNotifier<String> searchNotifier;
  const EnMora({super.key, required this.searchNotifier});

  @override
  State<EnMora> createState() => _EnMoraState();
}

class _EnMoraState extends State<EnMora> {
  final op = Operations();
  ...
  Future<void> getData() async {
    var data = await op.obtenerClientesEnMora();
