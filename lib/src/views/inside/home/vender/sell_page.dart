...
import 'package:abi_praxis_app/src/models/categorias_model.dart';
import 'package:abi_praxis_app/utils/list/category.dart';
import 'package:abi_praxis_app/utils/list/data_list_sell.dart';
                    ...
                    ? ListView.builder(
                        ...
                        itemBuilder: (context, i) {
                          return GestureDetector(
                            onTap: () {
                              if (listaCategorias[i].idCompraCategoria == 1) {
                                Platform.isAndroid
                                    ? andAlert.tipoTramiteCredito(context,
                                        idProducto: 1)
                                    : iosAlert.tipoTramiteCredito(context,
                                        idProducto: 1);
                              }
                            },
                            child: Container(
                                          ...
                                          : SizedBox(
                                              ...
                                              child: Swiper(
                                                ...
                                                itemBuilder: (context, index) {
                                                  return GestureDetector(
                                                    onTap: () {
                                                      if (listaCategorias[i]
                                                              .idCompraCategoria ==
                                                          1) {
                                                        Platform.isAndroid
                                                            ? andAlert.tipoTramiteCredito(
                                                                context,
                                                                idProducto: listaCategorias[
                                                                        i]
                                                                    .subcategorias![
                                                                        index]
                                                                    .idCompraSubCategoria!)
                                                            : iosAlert.tipoTramiteCredito(
                                                                context,
                                                                idProducto: listaCategorias[
                                                                        i]
                                                                    .subcategorias![
