...
import 'package:abi_praxis_app/utils/header_form_login.dart';
          ...
          children: [
            Checkbox(
                ...
                onChanged: (value) async {
                  ...
                  debugPrint("date autorization: $autorizationDate");
                }),
            GestureDetector(
              onTap: () async {
                String url =
    ...
    if (formKey.currentState!.validate()) {
      ...
      if (conditions && autorization) {
        ...
        scaffoldMessenger(context,
            "Marcar la casilla de autorización de datos y aceptar los términos y condiciones son necesarios para continuar.",
