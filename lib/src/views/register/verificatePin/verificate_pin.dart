...
import 'package:abi_praxis_app/src/controller/sms/ws_sms.dart';
import 'package:abi_praxis_app/src/views/register/verificatePin/phone_verificated.dart';
              ...
              GestureDetector(
                  onTap: () async {
                    ...
                    if (resultsms == "OK") {
                      ...
                      debugPrint("pin: $pin");
                      scaffoldMessenger(context, "Pin enviado correctamente",
                          icon: const Icon(Icons.check, color: Colors.green));
                    } else {
                      setState(() => loading = false);
                      scaffoldMessenger(context, resultsms,
